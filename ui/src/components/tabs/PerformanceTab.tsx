    ...
    const presets: Record<string, Partial<Settings>> = {
      eco: {
        detection: {
          ...
          thermal_confidence_threshold: 0.30,
        },
      ...
      balanced: {
        ...
        motion: { ...base.motion, algorithm: 'mog2', sensitivity: 8, min_area: 450, cooldown_seconds: 4 },
      ...
      quality: {
        ...
        motion: { ...base.motion, algorithm: 'mog2', sensitivity: 8, min_area: 400, cooldown_seconds: 4 },
        thermal: { ...base.thermal, enable_enhancement: true, enhancement_method: 'clahe', clahe_clip_limit: 2.0 },
        stream: {
          ...base.stream,
          protocol: 'tcp',
