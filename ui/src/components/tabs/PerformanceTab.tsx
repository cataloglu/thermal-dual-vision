...
export const CameraSettingsTab: React.FC<CameraSettingsTabProps> = ({ settings, onChange, onSave }) => {
  ...
  const applyPreset = async (presetId: 'eco' | 'balanced' | 'quality' | 'frigate') => {
    ...
    const presets: Record<string, Partial<Settings>> = {
      ...
      balanced: {
        detection: { ...base.detection, model: 'yolov8s-person', inference_fps: 5, inference_resolution: [640, 640], confidence_threshold: 0.30, thermal_confidence_threshold: 0.35 },
        motion: { ...base.motion, algorithm: 'mog2', sensitivity: 7, min_area: 500, cooldown_seconds: 7 },
      ...
      frigate: {
        ...
        motion: { ...base.motion, algorithm: 'mog2', sensitivity: 7, min_area: 500, cooldown_seconds: 7 },
        thermal: { ...base.thermal, enable_enhancement: true, enhancement_method: 'clahe', clahe_clip_limit: 2.0 },
        stream: { ...base.stream, protocol: 'tcp', capture_backend: 'ffmpeg', buffer_size: 1, reconnect_delay_seconds: 5, max_reconnect_attempts: 10, read_failure_threshold: 3, read_failure_timeout_seconds: 12 },
        event: { ...base.event, prebuffer_seconds: 5, postbuffer_seconds: 5, frame_interval: 2, min_event_duration: 1.0, cooldown_seconds: 7 },
      },
      quality: {
        detection: { ...base.detection, model: 'yolov9t', inference_fps: 7, inference_resolution: [640, 640], confidence_threshold: 0.30, thermal_confidence_threshold: 0.35 },
        motion: { ...base.motion, algorithm: 'mog2', sensitivity: 8, min_area: 450, cooldown_seconds: 7 },
        thermal: { ...base.thermal, enable_enhancement: true, enhancement_method: 'clahe', clahe_clip_limit: 2.0 },
        event: { ...base.event, min_event_duration: 1.0, cooldown_seconds: 7 },
      },
    }
